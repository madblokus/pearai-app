...
`);
        ...
        await (0, runCommand_1.runCommand)('pnpm', ['nx', 'run', `backend:${verb}:celery`]);
    }
}
BackendDeployApi.description = 'Deploys Celery Workers to AWS using previously built backend artifact';
