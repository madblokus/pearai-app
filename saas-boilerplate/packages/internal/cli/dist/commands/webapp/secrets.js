...
class WebappSecrets extends baseCommand_1.BaseCommand {
  ...
  service: ${color_1.color.green('webapp')}
...
`);
        await (0, secretsEditor_1.runSecretsEditor)({ serviceName: 'webapp', rootPath });
    }
}
WebappSecrets.description = 'Runs an ssm-editor helper tool in docker container to set runtime environmental variables of webapp service. ' +
