...
class WebappBuild extends baseCommand_1.BaseCommand {
    async run() {
...
WebappBuild.description = 'Build webapp artifact ready to be deployed to AWS';
WebappBuild.examples = [`$ <%= config.bin %> <%= command.id %>`];
